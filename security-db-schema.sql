...
-- object: public.refresh_tokens_id_seq | type: SEQUENCE --
...
CREATE TABLE public.refresh_tokens (
	id integer NOT NULL DEFAULT nextval('public.refresh_tokens_id_seq'::regclass),
	token varchar(1024) NOT NULL,
	id_users integer,
	created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
	expires_at timestamp,
	CONSTRAINT refresh_tokens_pk PRIMARY KEY (id),
	CONSTRAINT unique_constraint UNIQUE (token)
);
-- ddl-end --
...
-- object: users_fk | type: CONSTRAINT --
-- ALTER TABLE public.refresh_tokens DROP CONSTRAINT IF EXISTS users_fk CASCADE;
ALTER TABLE public.refresh_tokens ADD CONSTRAINT users_fk FOREIGN KEY (id_users)
REFERENCES public.users (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: token_indexes | type: INDEX --
-- DROP INDEX IF EXISTS public.token_indexes CASCADE;
CREATE INDEX token_indexes ON public.refresh_tokens
USING btree
(
	token
);
